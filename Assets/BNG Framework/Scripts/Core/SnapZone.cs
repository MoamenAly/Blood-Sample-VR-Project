...
namespace BNG {
    public class SnapZone : MonoBehaviour {
        ...
        public void _DisableCanRemoveItem() {
            CanRemoveItem = false;
        }
        ...
        // Method to remove a name from OnlyAllowNames
        public void RemoveAllowedName(string name)
        {
            if (OnlyAllowNames.Contains(name))
            {
                OnlyAllowNames.Remove(name);
                Debug.Log("Removed: " + name + " from OnlyAllowNames");
            }
            else
            {
                Debug.LogWarning("Name not found in OnlyAllowNames: " + name);
            }
        }
