...
namespace BNG {
    ...
    public class Grabbable : MonoBehaviour {
        ...
        //protected virtual void UpdateFixedJointAlignment()
        //{
        //    if (GrabPhysics == GrabPhysics.FixedJoint && BeingHeld)
        //    {
        //        Grabber grabber = GetPrimaryGrabber();
        //        if (grabber != null)
        //        {
        //            // Manually adjust the position and rotation to match the grabber's hand pose
        ...
        /// </summary>
       protected virtual void moveWithVelocity() {
        ...
        protected virtual void checkParentHands(Grabber g) {            
        ...
        protected virtual void rotateGrabber(bool lerp = false) {
            Grabber heldBy = GetPrimaryGrabber();
            if (heldBy != null) {
                Transform grabberTransform = heldBy.transform;
        ...
        public virtual void GrabItem(Grabber grabbedBy) {
            ...
            if (isPrimaryGrab) {
                ...
                if (primaryGrabOffset) {
                    ...
                    //ActiveGrabPoint.UpdatePreviews();
                    Debug.Log("*--> primary grab");
                }
                else {
                ...
                if (primaryGrabOffset != null && ActiveGrabPoint != null) {
                   ...
                   // Debug.Log("*-->"+ SelectedHandPose.name);
        ...
        { 
            ...
            {             
                transform.rotation = grabTransform.rotation;
                rigid.position = grabTransform.position;
                SetFixedJoint(grabbedBy);
            }
        }
        ...
        //    // Align the object's position and rotation with the grabber's position and rotation
        ...
        public virtual Transform GetClosestGrabPoint(Grabber grabber) {
            ...
            //Debug.Log("Grab point " + grabPoint.transform.name);
            return grabPoint;
        }
        ...
        protected void SetFixedJoint(Grabber grabbedBy)
        {
            FixedJoint joint = grabbedBy.gameObject.AddComponent<FixedJoint>();
            joint.connectedBody = rigid;
            joint.autoConfigureConnectedAnchor = false;
        ...
        protected virtual void addGrabber(Grabber g) {
            if (heldByGrabbers == null) {
