...
namespace BNG {
    ...
    public class GrabPoint : MonoBehaviour {
        ...
        public Vector3 previewModelOffsetLeft = new Vector3(0.0209999997f, 0.0299999993f, 0.0419999994f);// Old Offset = new Vector3(0.007f, -0.0179f, 0.0071f);
        //[SerializeField] Vector3 previewModelOffsetLeft = new Vector3(0.007f, -0.0179f, 0.0071f);// Old Offset = new Vector3(0.007f, -0.0179f, 0.0071f);
        public Vector3 previewModelOffsetRight = new Vector3(-0.029f, 0.0328f, 0.044f);// Old Offset = new Vector3(-0.01f, -0.0179f, 0.0071f);
