            ...
            if(grabber != null) {
                ...
                if (grabber.HeldGrabbable == null && PreviousHeldObject != null) {
                 ...
                 //   Debug.Log("-->Change");
                    ...
                    //grabber.HeldGrabbable == null && PreviousHeldObject != null;
                 //   Debug.Log("-->else");
                }
                    //Debug.Log("--> DROPING data" + grabber.HeldGrabbable +" " + PreviousHeldObject );
                   // Debug.Log("--> Pic data" + grabber.HeldGrabbable+" "+GameObject.ReferenceEquals(grabber.HeldGrabbable.gameObject, PreviousHeldObject));
            }
        }

        public virtual void OnGrabChange(GameObject newlyHeldObject) {

            Debug.Log("*--> "+HoldingObject()+ "newlyHeldObject " + newlyHeldObject);
        ...
        public virtual void UpdateCurrentHandPose() {
            if(handPoser != null) {
                ...
                // Check what HandPose is specified on the currently held grabbable
                    ...
                    handPoser.CurrentPose = grabber.HeldGrabbable.SelectedHandPose;
                   // Debug.Log("<**-->" + grabber.HeldGrabbable.SelectedHandPose.name);
                }
