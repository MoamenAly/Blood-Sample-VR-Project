...
namespace BNG {
    ...
    public class GrabbableEditor : Editor {
      ...
      protected SerializedProperty grabButton;
      protected SerializedProperty grabType;
      protected  SerializedProperty grabPhysics;
      protected  SerializedProperty grabMechanic;
      protected  SerializedProperty grabSpeed;
      protected  SerializedProperty remoteGrabbable;
      protected  SerializedProperty remoteGrabMechanic;
      protected  SerializedProperty remoteGrabDistance;
      protected  SerializedProperty throwForceMultiplier;
      protected  SerializedProperty throwForceMultiplierAngular;
      protected  SerializedProperty breakDistance;
      protected  SerializedProperty hideHandGraphics;
      protected  SerializedProperty parentToHands;
      protected  SerializedProperty parentHandModel;
      protected  SerializedProperty snapHandModel;
      protected  SerializedProperty canBeDropped;
      protected  SerializedProperty CanBeSnappedToSnapZone;
      protected  SerializedProperty ForceDisableKinematicOnDrop;
      protected  SerializedProperty InstantMovement;
      protected  SerializedProperty MakeChildCollidersGrabbable;        
      protected  SerializedProperty CustomHandPose;
      protected  SerializedProperty handPoseType;
      protected  SerializedProperty SelectedHandPose;
      protected  SerializedProperty SecondaryGrabBehavior;
      protected  SerializedProperty OtherGrabbableMustBeGrabbed;
      protected  SerializedProperty SecondaryGrabbable;
      protected  SerializedProperty SecondHandLookSpeed;
      protected  SerializedProperty TwoHandedPosition;
      protected  SerializedProperty TwoHandedPostionLerpAmount;
      protected  SerializedProperty TwoHandedRotation;
      protected  SerializedProperty TwoHandedRotationLerpAmount;
      protected  SerializedProperty TwoHandedDropBehavior;
      protected  SerializedProperty TwoHandedLookVector;
      protected  SerializedProperty CollisionSpring;
      protected  SerializedProperty CollisionSlerp;
      protected  SerializedProperty CollisionLinearMotionX;
      protected  SerializedProperty CollisionLinearMotionY;
      protected  SerializedProperty CollisionLinearMotionZ;
      protected  SerializedProperty CollisionAngularMotionX;
      protected  SerializedProperty CollisionAngularMotionY;
      protected  SerializedProperty CollisionAngularMotionZ;
      protected  SerializedProperty ApplyCorrectiveForce;
      protected  SerializedProperty MoveVelocityForce;
      protected  SerializedProperty MoveAngularVelocityForce;
      protected  SerializedProperty GrabPoints;
      protected  SerializedProperty collisions;
    //  protected  SerializedProperty SetGrabed;
       ...
       protected virtual void OnEnable() {
           ...
           // SetGrabed = serializedObject.FindProperty("_setFixedGrabed");
            //try
            //{
            //    handOffLayer = serializedObject.FindProperty(" handOff");
            //    handOnLayer = serializedObject.FindProperty(" handOn");
            //}
            //catch { }
        }
        ...
        public override void OnInspectorGUI() {
            ...
            //EditorGUILayout.PropertyField(SetGrabed);
