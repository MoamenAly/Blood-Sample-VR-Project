...
namespace VRUIP
{
    public class ColorPickerController : A_Canvas, IPointerDownHandler, IDragHandler, IEndDragHandler
    {
        ...
        {
           // Debug.Log("OnPointerDown color picker");
            if (eventData.pointerCurrentRaycast.gameObject == gradientImage.gameObject)
            {
                RectTransformUtility.ScreenPointToLocalPointInRectangle(gradientImage.rectTransform, eventData.position, eventData.pressEventCamera, out var localPoint);
        ...
        {
         //Debug.Log("On Draaaag color picker:   " + eventData.pointerCurrentRaycast.gameObject + "  poinerDrag:  " + eventData.pointerDrag.name + "  Camera: "+ eventData.pressEventCamera.name );
            if (eventData.pointerCurrentRaycast.gameObject == gradientImage.gameObject)
            {
